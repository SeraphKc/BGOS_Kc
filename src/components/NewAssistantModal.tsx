...
import {createAssistant} from '../services/AssistantCRUDService';
...
interface NewAssistantModalProps {
    onClose: () => void;
    userId: string;
    onCreate: (newAssistant) => void;
}

const NewAssistantModal: React.FC<NewAssistantModalProps> = ({onClose, userId, onCreate}) => {
    ...
    const handleCreateAssistant = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newAssistant = await createAssistant(userId, assistantData);
            onCreate(newAssistant);
            showNotification({
                type: 'success',
                title: 'Assistant created',
                message: `Assistant "${fields.name}" has been successfully created.`,
                autoClose: true,
                duration: 3000
            });
            onClose();
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <h2 style={{color: '#fff', fontSize: 20.5, fontWeight: 700, marginBottom: 4, textAlign: 'left'}}>New Assistant</h2>
          <div style={{
            color: '#fff',
            fontSize: 11.52,
            fontWeight: 400,
        ...
        >
          <input
            ...
            placeholder="How do you want to call your new assistant?"
            style={{
              width: '100%',
              padding: '10.24px',
              borderRadius: 11.52,
